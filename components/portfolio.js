...
import { StyleSheet, Text, View, Image, TextInput, Dimensions, ScrollView, List } from "react-native";
...
import { MaterialCommunityIcons, Feather, Entypo, AntDesign, FontAwesome } from '@expo/vector-icons';
...
const Portfolio = ({ ids }) => {
  ...
  return (
    ...
    <View style={styles.container}>
      <View style={{ justifyContent: "space-between", flexDirection: 'row', marginTop: '5%', backgroundColor: 'white' }} >
        <Feather name="menu" size={28} color="#112f4c" style={{ marginLeft: '2%' }} />
      ...
      <View style={{ alignItems: "center" }}>
        <View style={{ alignItems: "center", flexDirection: 'row', marginBottom: '7%' }}>
          ...
          <Button style={styles.searchBtn} onPress={onKeyPress}>
            <Entypo name="magnifying-glass" size={25} color="#f1c40f" style={{ padding: 10 }} />
          </Button>
        </View>
      </View>


      <View style={{ width: '90%', height: '77%', backgroundColor: '#112f4c', alignSelf: 'center' }}>
        <View style={{ borderBottomColor: 'white', borderBottomWidth: 0.5, width: '100%', justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center' }}>
